					...
					<div class="login_form">
						<form action="${ctp }/manager/login" name="loginform"
							...
							<div class="uinArea" id="uinArea">
								<div id="loginCue" class="cue">${indexInfo == null?"请您登录":indexInfo }</div>
							...
							<br/>
								...
								<div class="checkbox">
						            &nbsp;&nbsp;&nbsp;
						            <input id="remBtn" name="rem" type="checkbox" value="1"/>记住我
						          <label>
						           		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						           		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						           		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						           		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						           		<a href="${ctp }/forget.html">忘记密码</a>
						          </label>
						        </div>
							
							
							<div style="padding-left: 50px; margin-top: 20px;">
								<input id="loginBtn" type="button" value="登 录" style="width: 150px;"
									class="button_blue" />
							</div>
						</form>
					</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#reg').click(function() {
				...
				//账户是否唯一
				if (accountstop) {
					$('#userCue').html("<font color='red'><b>账号重复，请修改信息</b></font>");
					return false;
				}
				
				//邮箱是否唯一
				if (emailstop) {
					$('#userCue').html("<font color='red'><b>邮箱存在，请修改信息</b></font>");
					return false;
				}
			...
			$("#loginBtn").click(function(){
				...
				if ($('#u').val().length < 3
					...
					$('#loginCue').html("<font color='red'><b>账号名为3-16字符</b></font>");
					return false;
				}
